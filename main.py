...
if __name__ == '__main__':
	...
	#img = cv2.imread("testData/index.jpeg") #access granted
	#img = cv2.imread("testData/redcar.jpg")   #denied
	#img = cv2.imread("testData/vaibhav.jpg")
...
db = MySQLdb.connect("localhost","root","root","parking" )
sql = "SELECT * FROM user HAVING plate_no=\"" + text +"\""
cursor = db.cursor()
#cursor.execute(sql)
#row=cursor.fetchone()
#print(row)
