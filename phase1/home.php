...
echo $name;
 ...
 ?>
      ...
      <p></p>
      <hr>
        <form action="reg_form.php?id=<?php echo $sid; ?>&password=<?php echo $password; ?>" method="post" >
            ...
            <div class="contentform">
                ...
                <div class="leftcontact">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="father_name" id="father_name" data-rule="required" />
                        <div class="validation"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <!--input type="gender" name="gender" id="gender" data-rule="gender" /-->
                        <div class="validation"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mobn" id="mobn" data-rule="required" />
                        <div class="validation"></div>
                    </div>
                ...
                <div class="rightcontact">
                    ...
                    <div class="form-group">
                        ...
                        <!--input type="text" name="phychl" id="phychl" data-rule="required" /-->
                        <div class="validation"></div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" id="dob" data-rule="required" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <p>Full Address <span>*</span></p>
                        <span class="icon-case"><i class="fa fa-location-arrow"></i></span>
                        <input type="text" name="faddress" id="faddress" data-rule="required" />
                        <div class="validation"></div>
                    </div>
                </div>
                <button type="submit" class="bouton-contact">Submit</a></button>
        </form>
    </div>
    </div>
    <div class="col-sm-2 sidenav">
