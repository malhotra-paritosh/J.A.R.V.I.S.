    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="stulogin.php?id=<?php echo $sid; ?>&password=<?php echo $password; ?>?id=<?php echo $sid; ?>&password=<?php echo $password; ?>"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <p></p>
            <hr>
            <form action="cardata.php?id=<?php echo $sid; ?>&password=<?php echo $password; ?>" method="post" >
                ...
                <div class="contentform">
                    ...
                    <div class="form-group">
                        ...
                        <select class="topdown" type="tov" name="tov" id="gender" data-rule="gender" >
                            <option align="center" >Car</option>
                            <option align="center" >Bike</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <p>Vehicle Manufacturer<span>*</span></p>
                        <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="text" name="Vehiclem" id="Vehiclem" value="Maruti,Ford,Honda,bajaj,etc." data-rule="required" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <p>Vehicle Name<span>*</span></p>
                        <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="text" name="Vehicle_name" id="Vehicle_name"  data-rule="required" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <p>Registration Number<span>*</span></p>
                        <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="text" name="RCno" id="RCno"  data-rule="required" />
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <p>Registration Certificate Photocopy<span>*</span></p>
                        <input type="file" name="rimage"  id="rimage" rows="40" cols="90"/>
                        <div class="validation"></div>
                    </div>
                    <div class="validation"></div>
                </div>

                <button type="submit" class="bouton-contact" name="upload">Submit</a></button>
