...
<div class="container-fluid text-center">
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            ...
            <p></p>
            <hr>
            <form action="index.php?id=<?php echo $sid; ?>&password=<?php echo $password; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="contentform">
                    ...
                    <div class="form-group">
                        <p>Student ID (SID)<span>*</span></p>
                        <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="number" name="SID" id="SID" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                        <div class="validation"></div>
                    </div>
                    <div class="form-group">
                        <p>Student Name <span>*</span></p>
                        <span class="icon-case"><i class="fa fa-male"></i></span>
                        <input type="text" name="Sname" id="Sname" data-rule="required" />
                        <div class="validation"></div>
                    </div>

                    <div class="form-group">
                        <p>SID Photocopy<span>*</span></p>
                    ...
                    <div class="form-group">
                        ...
                        <select class="topdown" type="Course" name="Course" id="Course" data-rule="Course" >
                    ...
                    <button type="submit" class="bouton-contact" name="upload">Submit
